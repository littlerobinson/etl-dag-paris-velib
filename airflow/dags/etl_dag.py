...
def _transform_station_status_data(ti):
    ...
    current_data["id"] = (
        current_data["station_id"].astype(str)
        + "_"
        + current_data["last_reported"].astype(str)
    )
...
with DAG(
    ...
    with TaskGroup(group_id="weather_branch") as weather_branch:
        ...
        check_fetch_weather = BashOperator(
            task_id="check_fetch_weather",
        ...
        check_transform_weather = BashOperator(
            task_id="check_transform_weather",
            bash_command="sleep 5",
            trigger_rule="all_success",
        )
        ...
        check_create_weather_table = BashOperator(
            task_id="check_create_weather_table",
            bash_command="sleep 5",
            trigger_rule="all_success",
        )
    ...
    with TaskGroup(group_id="station_status_branch") as station_status_branch:
        ...
        check_fetch_station = BashOperator(
            task_id="check_fetch_station",
            bash_command="sleep 5",
            trigger_rule="all_success",
        )
        ...
        check_transform_station = BashOperator(
            task_id="check_transform_station",
            bash_command="sleep 5",
            trigger_rule="all_success",
        )
        ...
        check_create_station_table = BashOperator(
            task_id="check_create_station_table",
            bash_command="sleep 5",
            trigger_rule="all_success",
        )
        ...
        (
            ...
            >> check_transform_station
            >> create_station_status_table
            >> check_create_station_table
